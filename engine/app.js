...
import juegos from './screens/juegos.js';
import testsMenu from './screens/testsMenu.js';
...
function registrarPantallas() {
  ...
  router.registrar('juegos', juegos);
  router.registrar('tests', testsMenu);
  router.registrar('perfil', perfil);
